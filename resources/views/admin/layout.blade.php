...
<head>
    ...
    <link rel="stylesheet" href="/css/btn-togle.steles.css">
    <style>
        table.table form{
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="/loguot" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
...
<script>
    ...
    let sublist = document.querySelectorAll('[data-token]');
    for (let i=0; i<sublist.length; i++) {
        sublist[i].onclick = function(event) {
            $('#modal--show-token').text(this.getAttribute('data-token'))
            let bCopy = document.querySelector('#bCopy'), log = document.querySelector('#log');
            log.innerHTML = '';
            bCopy.addEventListener('click', e => {
                copy(this.getAttribute('data-token'));
                log.style.color = 'green';
                log.innerHTML = 'Скопировано!';
            });
            $('#show-token').modal('show')
        }
    }
